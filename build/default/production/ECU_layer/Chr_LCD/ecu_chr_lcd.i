...
# 13 "ECU_layer/Chr_LCD/../../MCAL_layer/GPIO/hal_gpio.h"
...
# 11 "ECU_layer/Chr_LCD/../../MCAL_layer/GPIO/../mcal_std_types.h"
...
# 11 "ECU_layer/Chr_LCD/../../MCAL_layer/GPIO/../mcal_std_types.h" 2
...
# 33 "ECU_layer/Chr_LCD/../../MCAL_layer/GPIO/../mcal_std_types.h"
...
# 1 "ECU_layer/Chr_LCD/../../MCAL_layer/GPIO/../../MCAL_layer/devic_config.h" 1
...
# 34 "ECU_layer/Chr_LCD/../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum {
    LOW = 0,
    HIGH
} logic_t;
...
# 36 "ECU_layer/Chr_LCD/ecu_chr_lcd.h"
typedef struct {
    pin_config_t lcd_rs;
    pin_config_t lcd_en;
...
# 7 "ECU_layer/Chr_LCD/ecu_chr_lcd.c" 2
...
Std_ReturnType lcd_4bit_initialize(const chr_lcd_4bit_t *lcd) {
    ...
    uint8 l_data_pins_counter = (uint8)0x00;
    if (((void*)0) == lcd) {
...
Std_ReturnType lcd_4bit_send_char_data_pos(const chr_lcd_4bit_t *lcd, uint8 row, uint8 column, uint8 data) {
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 l_pins_counter = (uint8)0x00;
    if (((void*)0) == lcd) {
        ret = (Std_ReturnType)0x00;
    } else {
...
Std_ReturnType lcd_4bit_send_string(const chr_lcd_4bit_t *lcd, uint8 *str) {
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 l_char_counter = (uint8)0x00;
    if (((void*)0) == lcd) {
        ret = (Std_ReturnType)0x00;
    } else {
        while (*str) {
...
Std_ReturnType lcd_8bit_send_command(const chr_lcd_8bit_t *lcd, uint8 command) {
    ...
    if (((void*)0) == lcd) {
        ...
        for (l_pins_counter = 0; l_pins_counter < 8; l_pins_counter++) {
            ret = gpio_pin_write_logic(&(lcd->lcd_data[l_pins_counter]),
                    (command >> l_pins_counter) & (uint8) 0x01);
        }
...
Std_ReturnType lcd_8bit_send_char_data(const chr_lcd_8bit_t *lcd, uint8 data) {
    ...
    if (((void*)0) == lcd) {
        ...
        for (l_pins_counter = 0; l_pins_counter < 8; l_pins_counter++) {
            ret = gpio_pin_write_logic(&(lcd->lcd_data[l_pins_counter]),
                    (data >> l_pins_counter) & (uint8) 0x01);
        }
        ret = lcd_8bits_send_enable_signal(lcd);
...
static Std_ReturnType lcd_8bit_set_cursor(const chr_lcd_8bit_t *lcd, uint8 row, uint8 column) {
    ...
    column--;
    switch (row) {
        case 1: ret = lcd_8bit_send_command(lcd, (0x80 + column));
            break;
...
static Std_ReturnType lcd_4bit_set_cursor(const chr_lcd_4bit_t *lcd, uint8 row, uint8 column) {
    ...
    column--;
    switch (row) {
        case 1: ret = lcd_4bit_send_command(lcd, (0x80 + column));
            break;
